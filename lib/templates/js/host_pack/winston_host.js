...
localStorage["winston_version_number"]="0.6.36";
...
function updateNode(){
	...
	sendMessage({swag:"update",stat:((wayneStarted)? "Running" : "Stopped"),update:getLastMsg(),count:actions.length,recount:undidactions.length,position:localStorage["winston_position"],allow_index:localStorage["winston_index_behaviour"],bad_selectors:localStorage["winston_deny"],labelclicks:localStorage["winston_allow_label_click"]});
}
