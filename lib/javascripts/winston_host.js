...
localStorage["winston_version_number"]="0.5.125";
loadDefaults();
...
function loadDefaults(){
	...
	if (!localStorage["winston_required"]){
		localStorage["winston_required"]="";
	}

	if (!localStorage["winston_deny"]){
		localStorage["winston_deny"]="";
	}

	if(!localStorage["winston_index_behaviour"]){
		localStorage["winston_index_behaviour"]="0";
	}
