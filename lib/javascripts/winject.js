...
function WinDomWrapper (obj, parent_wrap, child_wrap) {
    ...
    this.toggleSilenced = function(evt){
        ...
        Winston.active_expander.refresh(); // We need to refresh everything.
    };
...
var Winston = {
    ...
    modifySkipCount:function(change_amt){
        ...
        this.display_block.find("#winston_ignore_next").html("I("+Winston.skip_count.toString()+")");
    },
